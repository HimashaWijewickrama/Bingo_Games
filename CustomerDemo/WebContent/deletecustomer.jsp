...
<meta charset="utf-8">
  ...
  <title>Delete Favourites| BinGO</title>
...
<div class="intro intro-single route bg-image" style="background-image: url(assets/img/ludo.png)">
  ...
  <!-- ======= Update Section ======= -->
	...
	%>
         <b>Do You Want To Remove This Game From The Collection?</b><br>
...
<form action="delete" method="post">
	...
	<tr>
		<td><b>Developer</b></td>
		<td><input type="text" name="developer" value="<%= developer %>" readonly></td>
	</tr>
	<tr>
		<td><b>User name</b></td>
	...
	<div class="col-md-12">
                    <button type="submit" name="submit" value="Delete Details" class="button button-a button-big button-rouded">Delete Game</button>
                  </div>
